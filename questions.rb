...
def separate_array_into_even_and_odd_numbers(array)
	a = array.select {|number| number.even? }
	b = array.select {|number| !number.even?}
	return [a, b]
end
...
def call_method_from_string(str_method)
	str_method.each {|property| item.send(property).should raise_error(NameError)}
end
